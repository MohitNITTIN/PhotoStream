      ...
      >
        ...
        >
          ...
          <Box>
            ...
            <Typography mt="2px" fontSize="15px">
              <a style={{ fontSize: "15px" }} href="mailto: mohitsaini25j@gmail.com">
                mohitsaini25j@gmail.com
              </a>
            </Typography>
            <Typography mt="2px">
              <a style={{ fontSize: "15px" }} href="tel:9057701141">
                +91 9057701141
              </a>
            </Typography>
          </Box>
        ...
        >
          ...
          <FlexBox gap={4} justifyContent="flex-end">
            <a
              rel="noreferrer"
              href="https://github.com/MohitNITTIN"
              title="github"
              target="_blank"
            >
              <GitHubIcon />
            ...
            <a
              rel="noreferrer"
              href="https://www.linkedin.com/in/mohitkumar25j/"
              title="Linkedin"
              target="_blank"
            >
              <LinkedInIcon />
