...
export default function resetPassword(email, name, token) {
  return `<div>
      ...
      <div style="padding:20px;">
        ...
        border-radius:4px;
        font-size:16px;
        text-decoration:none;" href="${MODE === "dev" ? DEV_API : PROD_API
      ...
      <div style="background:gray;padding:20px;text-align:center;">
        ...
        <p>
        <a style="color:white;" href="tel:+91-905-770-1141">+91-905-770-1141</a>
        </p>
        <p>
              <a style="color:white;" href="mailto:mohitsaini25j@gmail.com">mohitsaini25j@gmail.com</a>
        </p>
      </div>
